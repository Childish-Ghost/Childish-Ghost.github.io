...
(function(){
  ...
  $(function(){
    ns_member.loading = function(member){
      ...
      console.log(view_social);
      view = "<div class=\"member\"><a href=\"" + member.avatar + "\" ><img class=\"pure-img-responsive\" src=\"" + member.avatar + "\"></a><h4>" + member.nick + " (" + member.id + ")</h4><span class=\"identity\"><em>" + member.identity + "</em></span><h5 class=\"title\">" + member.title + "</h5><p>" + member.content + "</p><div style=\"margin-bottom: .5em;\">" + view_social + "</div></div>";
